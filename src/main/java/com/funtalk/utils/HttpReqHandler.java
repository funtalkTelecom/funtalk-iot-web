...
public class HttpReqHandler
{
     ...
     */
    private static void initCert(String path, WxTransfersDto transfer)
...
//        requestConfig = RequestConfig.custom().setSocketTimeout(10000).setConnectTimeout(30000).build();
     ...
     * @throws KeyManagementException
     */
    public static String httpsRequest(String url, String xmlObj, WxTransfersDto model, String path)
        throws IOException, KeyStoreException, UnrecoverableKeyException,
        NoSuchAlgorithmException, KeyManagementException
    {
        // 加载证书

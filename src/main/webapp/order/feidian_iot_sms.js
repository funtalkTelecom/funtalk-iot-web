...
$("#iot_city_a").change(
		function() {
			...
			$.ajax({
				type : "POST",
				url : "../fdfdiotsmsAction!phoneAList.action",
				dataType : "json",
				data : {
					city_a : city_a
				},
...
$(".task_commit").click(function(){
	...
	if(phone_a!="" && phone_a!="0" && phone_b_list!=null){
		...
		$.ajax({
			type : "POST",
			url : "../fdfdiotsmsAction!smsTask.action",
			dataType : "json",
			data : {
				phone_a : phone_a,
			...
			success : function(json) {
				...
				var city_b = $("#iot_city_b").val();
					$.ajax({
					    type: "POST",
					    url:  "../fdfdiotsmsAction!addressList.action",
...
$("#operators").on("click",'.change', function() {
	...
	$.ajax({
		type : "POST",
		url : "../fdfdiotsmsAction!changecard.action",
		dataType : "json",
...
$(".del_now_use").click(function() {
	...
	$.ajax({
		type : "GET",
		url : "../fdfdiotsmsAction!delcard.action",
		dataType : "json",
		success : function(json) {
			tipBox.close();
			if (json.state == "0000") {
...
var timer = setInterval(function(){
	$.ajax({
		type : "GET",
		url : "../fdfdiotsmsAction!getcard.action",
		dataType : "json",
		success : function(json) {
...
(function() {
	...
	$.ajax({
		type : "GET",
		url : "../fdfdiotsmsAction!cityAList.action",
		dataType : "json",
		success : function(json) {			
			ul = JSON.parse(json.phoneListStr);
			console.log(ul);
...
//	$.ajax({
//				type : "GET",
//				url : "../fdiotsmsAction!phoneBList.action",
//				dataType : "json",
//				success : function(json) {
//					ul = JSON.parse(json.phoneListStr);
//					for ( var i in ul) {
...
//			});
	...
	$.ajax({
		type : "GET",
		url : "../fdfdiotsmsAction!cityBList.action",
		dataType : "json",
		success : function(json) {
			ul = JSON.parse(json.phoneListStr);
...
function axb_b_upload() {
	...
	$.ajax({
		type : "POST",
		url : "../fdfdiotsmsAction!FileUpload.action",
		processData : false,
		contentType : false,
		data : formData,
		dataType : "json",
...
$.ajax({
    type: "POST",
    url:  "../fdiotsmsAction!addressList.action",
    data: {page : 2}, 
    dataType : "json",  
    success: function( json ){   
    	var ultask = JSON.parse( json.addressListsTask );   

...
<table class="table table-bordered table-hover definewidth m10">
    <%--<tr>--%>
        <%--<td width="15%" class="tableleft">公司编号</td>--%>
        <%--<td style="text-align:left"><input  id="custId"  value="${cust.custId}" disabled="disabled" type="text" style="width:400px;"/>&nbsp;&nbsp;</td>--%>
    <%--</tr>--%>
    <tr>
        <td width="15%" class="tableleft">公司名称</td>
        <td style="text-align:left"><input  id="custName"  value="${cust.custName}" type="text" style="width:400px;"/>&nbsp;&nbsp;<span id="rescustname"></span></td>
    </tr>
    <tr>
        <td width="15%" class="tableleft">营业执照编码</td>
        <td style="text-align:left"><input id="idCode" value="${cust.idCode}"  type="text" style="width:400px;"/></td>
    </tr>

    <tr>
        <td width="15%" class="tableleft">地址</td>
        <td style="text-align:left"><input  id="address" value="${cust.address}" type="text" style="width:400px;"/></td>
    </tr>
    <tr>
        <td width="15%" class="tableleft">联系人</td>
        <td style="text-align:left"><input id="contacts" value="${cust.contacts}" type="text" style="width:300px;"></input>&nbsp;&nbsp;*必填</td>
    </tr>
    <tr>
        <td width="15%" class="tableleft">联系人电话</td>
        <td style="text-align:left"><input id="contactsNum" value="${cust.contactsNum}" type="text" style="width:300px;" ></input>&nbsp;&nbsp;*必填</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <c:choose>
            <c:when test="${cust.ifValid eq 1}"><td style="text-align:left"><input id="ifValid"  type="checkbox"   checked="checked" /></td></c:when>
            <c:otherwise><td style="text-align:left"><input id="ifValid"  type="checkbox"   /></td></c:otherwise>
        </c:choose>
	</tr> 
    <tr>
...
<script>
    ...
    function addcustomer(){
        ...
        $.ajax({
            type: "POST",
            url:  "${cpath}/cust/updatecustinfo",
            data: { custName:custName,idCode:idCode,address:address,
                    ifValid:ifValid,contactsNum:contactsNum,contacts:contacts,custId:custId,bill_price:bill_price,mode:mode},
            dataType : "json",
